...
(function (prizm) {
    var Para = (function () {
        ...
        Para.prototype.calc = function (balance, amount, last, genesisBalance, status) {
            var payout1 = this.ordinary(balance, amount, last, genesisBalance);
            var payout2 = this.compound(balance, amount, last, genesisBalance, status);
